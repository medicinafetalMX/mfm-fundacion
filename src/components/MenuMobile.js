    ...
    return (
      <div className="mobile-menu" ref={div => (this.bgOne = div)}>
        <div className="white-box" ref={div => (this.bgTwo = div)}>
          <Link to="/" ref={a => this.links.push(a)}>
            Inicio
          </Link>
          <Link to="/conocenos" ref={a => this.links.push(a)}>
            Conócenos
          </Link>
          <Link to="/educacion" ref={a => this.links.push(a)}>
            Educación
          </Link>
          <Link to="/investigacion" ref={a => this.links.push(a)}>
            Investigación
          </Link>
          <Link to="/laborsocial" ref={a => this.links.push(a)}>
            Labor Social
          </Link>
          <Link to="/neurodesarrollo" ref={a => this.links.push(a)}>
            Neurodesarrollo
          </Link>
          ...
          <Link to="/eventos" ref={a => this.links.push(a)}>
            Eventos
          </Link>
          <Link to="/foro" ref={a => this.links.push(a)}>
            Foro
          </Link>
          <Link to="/testimonios" ref={a => this.links.push(a)}>
            Testimonios
          </Link>
          <Link to="/apoya" ref={a => this.links.push(a)}>
            Cómo Apoyar
          </Link>
        </div>
      </div>
