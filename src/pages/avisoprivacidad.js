...
const avisoprivacidad = () => {
  return (
    <Layout>
      <SEO title="aviso de privacidad"></SEO>
      <div>
        ...
        >
          ...
          <p style={{ textJustify: "inter-word" }}>
            ...
            lo sucesivo denominada como la “ORGANIZACIÓN”, se encuentra ubicada
            en Blvd. Bernardo Quintana Núm. 4060, Int. 508, Col. San Pablo,
            76125, Querétaro, Querétaro, México, con número de teléfono: 442 195
            7014 y correo electrónico: fundacion@medicinafetalmexico.com; es el
      ...
      >
        <p>
          <strong>
            Los datos personales que la “ORGANIZACIÓN” obtiene, almacena y usa,
            le son proporcionados de manera voluntaria por usted para las
        ...
        <p>
          <ul>
            ...
            <li>
              Darlo de alta en nuestros sistemas como participantes o prospecto
              de participante
            </li>
            <li>
            ...
            <li>
              Efectuar el cobro correspondiente y generar el comprobante fiscal
            </li>
          ...
          <i>
            ...
            para brindarle nuestros servicios, pero pueden resultar en su
            interés, y contribuyen a desarrollar nuestros legítimos intereses
            altruistas y/o académicos:
          </i>
          <ul>
